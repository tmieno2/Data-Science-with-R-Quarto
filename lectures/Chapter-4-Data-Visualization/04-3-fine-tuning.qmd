...
There are a bunch of pre-made themes from the `ggplot2` and `ggtheme` packages that can quickly change how figures look.

Install and library  `ggtheme` package first:
