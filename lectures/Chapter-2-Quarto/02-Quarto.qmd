...
You can knit an qmd file to various formats using various engines (visit [here](https://quarto.org/docs/output-formats/all-formats.html) to see all the document types).
