...
+ First create or provide `bibliography.json` before switching to it, or continue using the existing `bibliography.bib`. If you switch to a valid CSL-JSON file, render again and check that citations and references are still there.
:::
