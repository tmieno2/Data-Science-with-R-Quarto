...
```{r}
#| echo: false
corn_yields <- haven::read_dta(here::here("lectures/Chapter-3-DataWrangling/corn_yields.dta"))
```
...
```{r, echo = F}
corn_yields <- readRDS(here::here("lectures/Chapter-3-DataWrangling/corn_yields.rds"))
```
