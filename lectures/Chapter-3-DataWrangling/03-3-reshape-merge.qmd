...
Reshape the data (`num_flights`) into a wide format so that you have number of flights per month in columns and assign it to an R object named `num_flights_wide`.
