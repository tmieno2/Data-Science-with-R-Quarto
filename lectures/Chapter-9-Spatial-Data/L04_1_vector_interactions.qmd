...
+ `dist`: the distance threshold. It is **required** — there is no default — and it
is in the units of the CRS, so degrees for unprojected lon/lat data and metres for
most projected data.
