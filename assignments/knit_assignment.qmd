...
strip_answers <- function(file) {
  ...
  if (num_pairs == 0) {
    ...
    qmd_body <- qmd_no_rchunks[-remove_lines]
  }


  if (!is.na(qmd_instruction)) {
    qmd_out <- c(qmd_instruction, qmd_body)
  } else {
    qmd_out <- qmd_body
  }
...
```{r}
gen_student_version(
  qmd_instructor = here::here("assignments/Assignment_2/Assignment-2-gen.qmd"),
  qmd_student = here::here("assignments/Assignment_2_student/Assignment-2-student.qmd")
)
```
...
```{r}
gen_student_version(
  qmd_instructor = here::here("assignments/Assignment_3/Assignment-3-gen.qmd"),
  qmd_student = here::here("assignments/Assignment_3_student/Assignment-3-student.qmd")
)
```
