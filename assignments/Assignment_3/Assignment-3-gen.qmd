...
```{r echo = F}
trial_design <- readRDS(here::here("assignments/Assignment_3/trial_design.rds"))
```
...
ggsave(here::here("assignments/Assignment_3/g_trial_design.png"), g_td)
```
...
```{r echo = F}
yield <- readRDS(here::here("assignments/Assignment_3/yield.rds"))
```
...
ggsave(here::here("assignments/Assignment_3/g_yield.png"), g_yield)
```
...
```{r echo = F}
NH3 <- st_read(here::here("assignments/Assignment_3/NH3.gpkg"))
```
...
ggsave(here::here("assignments/Assignment_3/g_NH3.png"), g_NH3)
```
...
```{r eval = F, echo = F}
ec <- st_read(here::here("assignments/Assignment_3/ec.shp"))
...
st_rasterize(grids) %>%
  as("Raster") %>%
  saveRDS(here::here("assignments/Assignment_3/ec.rds"))
```


```{r echo = F}
ec <- readRDS(here::here("assignments/Assignment_3/ec.rds"))
...
ggsave(here::here("assignments/Assignment_3/g_ec.png"), g_ec)
```
...
g_three <- g_yield / g_NH3 / g_ec

ggsave(here::here("assignments/Assignment_3/g_three.png"), g_three)
```
